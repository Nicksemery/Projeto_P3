...
public record DadosDetalhamentoLancamento(long id, String descricao, LocalDate data_vencimento, LocalDate data_pagamento, double valor, String observacao, TipoLancamento tipo) {
